...
public class MvcSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  CorsConfigurationSource corsConfigurationSource() {
    ...
    configuration.setAllowedOrigins(Arrays.asList("http://localhost:9876", "http://localhost:4200", "http://localhost:8102", "http://192.168.1.100:8102", "http://180.212.209.74:8102"));
